...
<?php
    ...
    $kode = isset($nin['nin']) ? $nin['nin'] : 'NSB0000000';
    ...
    if(isset($_POST['simpan'])){
        ...
        $insert = mysqli_query($conn, "INSERT INTO nasabah (nin, nama, rt, alamat, telepon, email, password, saldo, sampah) VALUES ('$nin','$nama','$rt','$alamat','$telepon','$email','$password','$saldo','$sampah')");
...
<body>
    ...
    <form id="daftar_user" action="" method="post" onsubmit="return cek_data()">
        ...
        <div class="form-group">
            <input type="hidden" name="sampah" value="0" />
        </div>
