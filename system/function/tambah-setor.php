...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO setor (tanggal_setor, nin, jenis_sampah, berat, harga, total, nia) VALUES ('$tanggal_setor', '$nin', '$jenis_sampah', '$berat', '$harga', '$total', '$nia')";
...
<body>
		...
		<button type="button" id="btn-tambah-form"  style="width:15%;">Tambah Data Form</button>
		<button type="button" id="btn-reset-form"  style="width:10%;">Reset Form</button><br><br>
     <form id="daftar_user" name="autoSumForm" action="" method="post" onsubmit="return cek_data()">
        <div class="form-group">
            <label>Tanggal Penyetoran</label>
            <input type="datetime-local" placeholder="Masukan tanggal setor" id="date"  name="tanggal_setor" />
        </div>
        <div class="form-group">
            <label>Nomor Induk Nasabah</label>
            <select name="nin" class="nomornasabah">
        ...
        <div class="form-group">
            ...
            <select name="jenis_sampah" class="jensampah" id="jenis_sampah" onchange="changeValue(this.value)">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nia" value="<?php echo $_SESSION['nia']; ?>" readonly />
        </div>
	...
	<input type="hidden" id="jumlah-form" value="1">
        ...
        <script type="text/javascript">   
          document.addEventListener("DOMContentLoaded", function() {
              ...
              document.getElementById('date').min = datetimeLocal;
          }); 
          <?php echo $jsArray; ?>  
