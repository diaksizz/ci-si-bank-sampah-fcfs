	...
	<body>
		<div class="sidebar">
			<ul>
				...
				<li>
					<a href="nasabah.php?page=antrian"><span class="fa fa-handshake-o" aria-hidden="true"></span>Antrian</a>
				</li>
				
				<li>
					<a href="http://localhost/bsk09/page/register.php"><span class="fa fa-handshake-o" aria-hidden="true"></span>Register</a>
				</li>
				...
				<?php 
					...
					switch ($page) {
						...
						case 'data-report':
							...
							break;
						case 'antrian':
							include "../system/function/statistik-fifo.php";
							break;
						case 'edit-nasabah':
