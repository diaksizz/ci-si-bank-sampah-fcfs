	...
	<body>
		...
		<div class="sidebar">
			<ul>
				...
				<li>
					<a href="admin.php?page=statistik-fifo"><span class="fa fa-handshake-o" aria-hidden="true"></span>Data Antrian (FIFO)</a>
				</li>
				
				<li>
					<a href="admin.php?page=data-sampah"><span class="fa fa-trash" aria-hidden="true"></span>Register</a>
				</li>
